...
import {
  Users, FileText, BookOpen, Database, Receipt, ArrowLeftRight, BarChart3, Building2, Landmark, Building,
} from "lucide-react";
...
const nav = [
  ...
  { href: "/admin/center-master",          icon: Building,       label: "Center Master" },
